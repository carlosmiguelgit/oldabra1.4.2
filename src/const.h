...
enum item_t : uint16_t {
	...
	ITEM_DEPOT = 2594,//sprite depot dentro do locker
	ITEM_LOCKER1 = 2589, //sprite locker do dp
	ITEM_MARKET = 8478,//sprite do market no dp
	ITEM_INBOX = 8524, //spr MAIL ou inbox
	ITEM_STORE_INBOX = 8525, // 23396 no object builder
	ITEM_STORE_COIN = 8351, // in-game store currency
