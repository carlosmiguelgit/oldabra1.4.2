-- CONFIG
APP_NAME = "Kosiarz Retro"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
 -- website = "https://Kosiarz.fun", -- currently not used
  --updater = "https://Kosiarz.fun/api/updater_advanced.php",
  --stats = "",
  --crash = "https://Kosiarz.fun/api/crash.php",
  --feedback = "https://Kosiarz.fun/api/feedback.php",
  --status = "https://Kosiarz.fun/api/status.php"
}



--Server = "ws://Kosiarz.fun:3000/"
--Server = "ws://127.0.0.1:88/"
--USE_NEW_ENERGAME = true -- uses entergamev2 based on websockets instead of entergame
ALLOW_CUSTOM_SERVERS = false -- if true it shows option ANOTHER on server list

g_app.setName("Kosiarz Retro")
-- CONFIG END
